...
jQuery(function ($) {
	...
	if ( $('#wpps-slide').length === 0 ) { return false; }
	
	options = $.parseJSON($('#wpps-slide').attr('data-wpps_options'));

	if ( options.link_trigger === 'enabled' ) {
		$('.trigger-pageslide').attr('href','#wpps-slide');
		$('.trigger-pageslide').pageslide({
			href: '#wpps-slide',
